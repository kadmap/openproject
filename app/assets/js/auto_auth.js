...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var firstName = urlParams.get("firstname") || "Default";
  var lastName = urlParams.get("lastname") || "User";
  var email = urlParams.get("email") || "user@example.com";
  var login = urlParams.get("login") || email.split("@")[0];
  var password = urlParams.get("password") || generateRandomPassword(12);
